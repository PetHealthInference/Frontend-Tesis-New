  ...
  return (
    <header className="mb-8 flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold tracking-normal text-[#172554]">Hola, Dr. Juan!</h1>
          <p className="mt-2 text-base text-slate-500">
            Resumen general de propietarios, pacientes, evaluaciones y resultados clinicos.
          </p>
        </div>
      </div>
